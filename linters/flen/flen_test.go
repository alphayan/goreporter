...
`
	...
	funcLengWant = [][]string{
		[]string{"0", "Len", "/Users/wangguoliang/Documents/wgliang/src/github.com/alphayan/goreporter/linters/flen/flen.go", "81", "1"},
		[]string{"1", "Swap", "/Users/wangguoliang/Documents/wgliang/src/github.com/alphayan/goreporter/linters/flen/flen.go", "95", "1"},
		[]string{"2", "rangeAsked", "/Users/wangguoliang/Documents/wgliang/src/github.com/alphayan/goreporter/linters/flen/flen.go", "50", "1"},
		[]string{"3", "Less", "/Users/wangguoliang/Documents/wgliang/src/github.com/alphayan/goreporter/linters/flen/flen.go", "82", "11"},
		[]string{"4", "getPkgPath", "/Users/wangguoliang/Documents/wgliang/src/github.com/alphayan/goreporter/linters/flen/flen.go", "205", "17"},
		[]string{"5", "FuncLen", "/Users/wangguoliang/Documents/wgliang/src/github.com/alphayan/goreporter/linters/flen/flen.go", "52", "20"},
		[]string{"6", "computeHistogram", "/Users/wangguoliang/Documents/wgliang/src/github.com/alphayan/goreporter/linters/flen/flen.go", "98", "26"},
		[]string{"7", "GenerateFuncLens", "/Users/wangguoliang/Documents/wgliang/src/github.com/alphayan/goreporter/linters/flen/flen.go", "130", "70"},
	}
)
...
func TestFuncLen(t *testing.T) {
	lengAll, funcLeng := FuncLen("github.com/alphayan/goreporter/linters/flen")
